...
class WhaleEnemy(Entity):
    def __init__(self, x, y, speed, resource_manager):
        super().__init__(x, y, speed, resource_manager, 'Whale')
...
class badPirate(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, speed, resource_manager):
                ...
                for animation in animation_types:
                    ...
                    n_frames = len(os.listdir(f'assets/enemies/Bad_Pirate/{animation}'))
                    for i in range(1, n_frames + 1):  # Empieza desde 1 en lugar de 0
                        img_path = f'assets/enemies/Bad_Pirate/{animation}/{i}.png'
...
class Capitan(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, speed, resource_manager):
                ...
                for animation in animation_types:
                    ...
                    # Contamos n de ficheros en la carpeta
                    n_frames = len(os.listdir(f'assets/enemies/Capitan/{animation}'))
                    for i in range(1, n_frames + 1):  # Empieza desde 1 en lugar de 0
                        img_path = f'assets/enemies/Capitan/{animation}/{i}.png'
                        img = self.resource_manager.load_image(img_path, img_path)
                        if img is not None:  # Asegurarse de que la imagen se ha cargado correctamente
                            temp_list.append(img)
                        else:
